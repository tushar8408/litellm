...
{{- if .host }}
{{- if .useIAMAuth }}
{{- fail "database.reader.useIAMAuth is not supported yet (IAM-auth read replicas require parsing DATABASE_URL_READ_REPLICA at runtime, not implemented in chart)" }}
{{- end }}
